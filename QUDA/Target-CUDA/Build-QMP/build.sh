...
_main_ "$QUDA_HOME" "$QMP_HOME" "$EIGEN_HOME" "$QIO_HOME" "$LIME_HOME" || return
...
_USQCD_PATH="${_QMP_PATH}:${_QIO_PATH}:${LIME_HOME}${CMAKE_PREFIX_PATH:+:}"
...
cmake -Wno-dev \
 ...
 -DCLime_DIR="$_QIO_PATH/lib/cmake/CLime" \
